...
source(file = "/home/bobo/Bureau/Git/script/RNAseq/fonction.r")
```

# Informations générales {.tabset}
...
DT.table(as.data.frame(res[,c("baseMean","log2FoldChange","pvalue","padj","Expression")]), filename="matrice_count")
```
